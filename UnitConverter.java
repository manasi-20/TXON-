...
public class UnitConverter {
	...
	public static void main(String[] args) {
		...
		/* Asking the user to input a number and unit of measurement with a space between them.
		The number is then stored as a double, and the unit of measurement is stored as a String.
		*/
